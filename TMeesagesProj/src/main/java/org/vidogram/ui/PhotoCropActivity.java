...
public class PhotoCropActivity extends BaseFragment
{
  ...
  public View createView(Context paramContext)
  {
    ...
    this.actionBar.setTitle(LocaleController.getString("CropImage", 2131165594));
  ...
  public boolean onFragmentCreate()
  {
    ...
    {
      String str = getArguments().getString("photoPath");
      Uri localUri = (Uri)getArguments().getParcelable("photoUri");
      ...
      int j;
      for (int i = AndroidUtilities.dp(520.0F); ; j = Math.max(AndroidUtilities.displaySize.x, AndroidUtilities.displaySize.y))
      {
  ...
  private class PhotoCropView extends FrameLayout
  {
      ...
      setOnTouchListener(new View.OnTouchListener()
      {
        public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
        {
          ...
          do
          {
            ...
            if ((PhotoCropActivity.PhotoCropView.this.rectX - i + PhotoCropActivity.PhotoCropView.this.rectSizeX < f4) && (PhotoCropActivity.PhotoCropView.this.rectX + i + PhotoCropActivity.PhotoCropView.this.rectSizeX > f4) && (PhotoCropActivity.PhotoCropView.this.rectY - i + PhotoCropActivity.PhotoCropView.this.rectSizeY < f5))
            {
              f1 = PhotoCropActivity.PhotoCropView.this.rectY;
              if (i + f1 + PhotoCropActivity.PhotoCropView.this.rectSizeY > f5)
              {
          ...
          while ((paramMotionEvent.getAction() != 2) || (PhotoCropActivity.PhotoCropView.this.draggingState == 0));
          ...
          {
            paramView = PhotoCropActivity.PhotoCropView.this;
            paramView.rectX = (f2 + paramView.rectX);
            paramView = PhotoCropActivity.PhotoCropView.this;
            paramView.rectY = (f1 + paramView.rectY);
            ...
            while (true)
            {
              ...
              if (PhotoCropActivity.PhotoCropView.this.draggingState == 1)
              {
                ...
                if (!PhotoCropActivity.PhotoCropView.this.freeform)
                {
                  ...
                  paramView.rectY += f1;
                  paramView = PhotoCropActivity.PhotoCropView.this;
                  paramView.rectSizeX -= f1;
                  paramView = PhotoCropActivity.PhotoCropView.this;
                  paramView.rectSizeY -= f1;
                  continue;
                }
                f3 = f1;
                ...
                paramView.rectY += f1;
                paramView = PhotoCropActivity.PhotoCropView.this;
                paramView.rectSizeX -= f2;
                paramView = PhotoCropActivity.PhotoCropView.this;
                paramView.rectSizeY -= f1;
                continue;
              }
              if (PhotoCropActivity.PhotoCropView.this.draggingState == 2)
              {
                f3 = f2;
                if (PhotoCropActivity.PhotoCropView.this.rectSizeX + f2 < 160.0F)
                  f3 = -(PhotoCropActivity.PhotoCropView.this.rectSizeX - 160.0F);
                ...
                if (!PhotoCropActivity.PhotoCropView.this.freeform)
                {
                  ...
                  paramView.rectSizeX += f1;
                  paramView = PhotoCropActivity.PhotoCropView.this;
                  paramView.rectSizeY = (f1 + paramView.rectSizeY);
                  continue;
                }
                f3 = f1;
                if (PhotoCropActivity.PhotoCropView.this.rectSizeY - f1 < 160.0F)
                ...
                paramView.rectY += f1;
                paramView = PhotoCropActivity.PhotoCropView.this;
                paramView.rectSizeX = (f2 + paramView.rectSizeX);
                paramView = PhotoCropActivity.PhotoCropView.this;
                paramView.rectSizeY -= f1;
                continue;
              }
              ...
              paramView.rectSizeX -= f2;
              paramView = PhotoCropActivity.PhotoCropView.this;
              paramView.rectSizeY = (f3 + paramView.rectSizeY);
          ...
          for (paramView.rectSizeY = (f1 + paramView.rectSizeY); ; paramView.rectSizeY = (f2 + paramView.rectSizeY))
          {
            ...
            paramView = PhotoCropActivity.PhotoCropView.this;
            paramView.rectSizeX = (f3 + paramView.rectSizeX);
            paramView = PhotoCropActivity.PhotoCropView.this;
          }
        }
      });
    ...
    private void updateBitmapSize()
    {
      ...
      while (true)
      {
        ...
        break;
        label293: if (this.bitmapWidth > this.bitmapHeight)
        {
          this.rectY = this.bitmapY;
        ...
        continue;
        label408: this.rectX = (f1 * this.bitmapWidth + this.bitmapX);
    ...
    public Bitmap getBitmap()
    {
      ...
      int i1 = (int)(f1 * PhotoCropActivity.this.imageToCrop.getWidth());
      int m = (int)(PhotoCropActivity.this.imageToCrop.getHeight() * f2);
      ...
      while (true)
      {
        if (i + k > PhotoCropActivity.this.imageToCrop.getWidth())
 ...
 * Qualified Name:     org.vidogram.ui.PhotoCropActivity
