...
public class RadialProgress
{
  ...
  private void invalidateParent()
  {
    ...
    this.parent.invalidate((int)this.progressRect.left - i, (int)this.progressRect.top - i, (int)this.progressRect.right + i * 2, i * 2 + (int)this.progressRect.bottom);
  }
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    while (true)
    {
      ...
      break;
      label309: this.currentDrawable.setAlpha(255);
      break label114;
      label322: progressPaint.setAlpha(255);
    }
    label334: updateAnimation(false);
  }
 ...
 * Qualified Name:     org.vidogram.ui.Components.RadialProgress
