...
public class PagerSlidingTabStrip extends HorizontalScrollView
{
  ...
  private void addIconTab(int paramInt, Drawable paramDrawable)
  {
    boolean bool = true;
    2 local2 = new ImageView(getContext(), paramInt)
    {
      protected void onDraw(Canvas paramCanvas)
      {
        super.onDraw(paramCanvas);
        if ((PagerSlidingTabStrip.this.pager.getAdapter() instanceof PagerSlidingTabStrip.IconTabProvider))
          ((PagerSlidingTabStrip.IconTabProvider)PagerSlidingTabStrip.this.pager.getAdapter()).customOnDraw(paramCanvas, this.val$position);
      }
    };
    local2.setFocusable(true);
    local2.setImageDrawable(paramDrawable);
    local2.setScaleType(ImageView.ScaleType.CENTER);
    local2.setOnClickListener(new View.OnClickListener(paramInt)
    {
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    if ((this.currentPositionOffset > 0.0F) && (this.currentPosition < this.tabCount - 1))
    {
      ...
      f1 = this.currentPositionOffset * f4 + f1 * (1.0F - this.currentPositionOffset);
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    this.tabsContainer.measure(paramInt1 | 0x40000000, paramInt2);
  }
  ...
  {
    this.delegatePageListener = paramf;
  }
 ...
 * Qualified Name:     org.vidogram.ui.Components.PagerSlidingTabStrip
