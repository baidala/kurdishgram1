...
public class SlidingTabView extends LinearLayout
{
  ...
  public void addTextTab(int paramInt, String paramString)
  {
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    if (this.tabX != this.animateTabXTo)
    {
      ...
      this.startAnimationTime = System.currentTimeMillis();
      this.totalAnimationDiff = (l1 - l2 + this.totalAnimationDiff);
    ...
    while (true)
    {
      ...
      return;
      label115: this.tabX = (this.startAnimationX + this.interpolator.getInterpolation((float)this.totalAnimationDiff / 200.0F) * (this.animateTabXTo - this.startAnimationX));
      invalidate();
    }
  }
 ...
 * Qualified Name:     org.vidogram.ui.Components.SlidingTabView
