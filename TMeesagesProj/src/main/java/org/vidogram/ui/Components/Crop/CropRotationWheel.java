...
public class CropRotationWheel extends FrameLayout
{
  ...
  public CropRotationWheel(Context paramContext)
  {
    ...
    this.aspectRatioButton.setImageResource(2130838095);
    ...
    this.rotation90Button.setImageResource(2130838103);
  ...
  protected void drawLine(Canvas paramCanvas, int paramInt1, float paramFloat, int paramInt2, int paramInt3, boolean paramBoolean, Paint paramPaint)
  {
    ...
    while (true)
    {
      ...
      label157: for (paramInt2 = AndroidUtilities.dp(16.0F); ; paramInt2 = AndroidUtilities.dp(12.0F))
      {
        paramCanvas.drawRect(i - paramInt1 / 2, (paramInt3 - paramInt2) / 2, paramInt1 / 2 + i, (paramInt2 + paramInt3) / 2, paramPaint);
        return;
        paramInt1 = 2;
        break;
      }
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    if (i < 16)
    {
      ...
      label192: label201: for (boolean bool = true; ; bool = false)
      {
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    do
    {
      ...
      f1 = this.prevX;
      f2 = this.rotation;
      f2 = Math.max(-45.0F, Math.min(45.0F, (float)((f1 - f3) / AndroidUtilities.density / 3.141592653589793D / 1.649999976158142D) + f2));
    }
  ...
  public void setAspectLock(boolean paramBoolean)
  {
    ...
    if (paramBoolean);
    for (int i = 2130838096; ; i = 2130838095)
    {
  ...
  public void setRotation(float paramFloat, boolean paramBoolean)
  {
    ...
    paramFloat = f;
    if (Math.abs(f) < 0.09900000000000001D)
 ...
 * Qualified Name:     org.vidogram.ui.Components.Crop.CropRotationWheel
