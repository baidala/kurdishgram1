...
public class PhotoFilterCurvesControl extends View
{
  ...
  private void handlePan(int paramInt, MotionEvent paramMotionEvent)
  {
    ...
    case 2:
      ...
      while (true)
      {
        ...
        break;
        paramMotionEvent.blacksLevel = Math.max(0.0F, Math.min(100.0F, f3 + paramMotionEvent.blacksLevel));
        continue;
        paramMotionEvent.shadowsLevel = Math.max(0.0F, Math.min(100.0F, f3 + paramMotionEvent.shadowsLevel));
        continue;
        paramMotionEvent.midtonesLevel = Math.max(0.0F, Math.min(100.0F, f3 + paramMotionEvent.midtonesLevel));
        continue;
        paramMotionEvent.highlightsLevel = Math.max(0.0F, Math.min(100.0F, f3 + paramMotionEvent.highlightsLevel));
        continue;
        paramMotionEvent.whitesLevel = Math.max(0.0F, Math.min(100.0F, f3 + paramMotionEvent.whitesLevel));
      }
    case 3:
    case 4:
    case 5:
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    case 3:
      while (true)
      {
        label219: f2 = this.textPaint.measureText((String)localObject);
        f3 = this.actualArea.x;
        paramCanvas.drawText((String)localObject, (f1 - f2) / 2.0F + f3 + i * f1, this.actualArea.y + this.actualArea.height - AndroidUtilities.dp(4.0F), this.textPaint);
        i += 1;
        break label219;
        this.paintCurve.setColor(-1);
 ...
 * Qualified Name:     org.vidogram.ui.Components.PhotoFilterCurvesControl
