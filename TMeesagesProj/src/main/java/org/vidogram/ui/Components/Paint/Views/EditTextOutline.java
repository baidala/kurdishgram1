...
public class EditTextOutline extends EditText
{
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    while (true)
    {
      ...
      this.mCanvas.translate(getPaddingLeft(), f + getPaddingTop());
      ...
      return;
      label259: f = (float)Math.ceil(getTextSize() / 11.5F);
    }
  }
 ...
 * Qualified Name:     org.vidogram.ui.Components.Paint.Views.EditTextOutline
