  ...
  public PickerBottomLayoutViewer(Context paramContext, boolean paramBoolean)
  {
    ...
    if (this.isDarkTheme)
    {
      ...
      if (!this.isDarkTheme)
        break label448;
      i = -12763843;
      label93: localTextView.setBackgroundDrawable(Theme.createSelectorDrawable(i, 0));
      ...
      if (!this.isDarkTheme)
        break label460;
      i = -12763843;
      label235: localTextView.setBackgroundDrawable(Theme.createSelectorDrawable(i, 0));
      this.doneButton.setPadding(AndroidUtilities.dp(20.0F), 0, AndroidUtilities.dp(20.0F), 0);
      this.doneButton.setText(LocaleController.getString("Send", 2131166409).toUpperCase());
    ...
    label442: label448: label454: label460: label466: for (int i = 2130838012; ; i = 2130837630)
    {
 ...
 * Qualified Name:     org.vidogram.ui.Components.PickerBottomLayoutViewer
