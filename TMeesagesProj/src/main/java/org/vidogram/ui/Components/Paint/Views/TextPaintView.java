...
public class TextPaintView extends EntityView
{
  ...
  public TextPaintView(Context paramContext, Point paramPoint, int paramInt, String paramString, Swatch paramSwatch, boolean paramBoolean)
  {
    ...
    this.editText.addTextChangedListener(new TextWatcher()
    {
      ...
      public void beforeTextChanged(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3)
      {
        ...
        this.beforeCursorPosition = paramInt1;
      }
  ...
  protected Rect getSelectionBounds()
  {
    ...
    return new Rect((this.position.x - f2 / 2.0F) * f1, (this.position.y - f3 / 2.0F) * f1, f2 * f1, f1 * f3);
  }
  ...
  {
    public TextViewSelectionView(Context arg2)
    {
      super(localContext);
    }
    ...
    protected void onDraw(Canvas paramCanvas)
    {
      ...
      while (i < j)
      {
        ...
        paramCanvas.drawRect(f9, f5 + f7 - f3 / 2.0F, f9 + f2, f3 / 2.0F + (f5 + f7), this.paint);
        i += 1;
      }
      ...
      while (i < j)
      {
        ...
        paramCanvas.drawRect(f5 + f6 - f3 / 2.0F, f9, f3 / 2.0F + (f5 + f6), f9 + f2, this.paint);
        i += 1;
      }
 ...
 * Qualified Name:     org.vidogram.ui.Components.Paint.Views.TextPaintView
