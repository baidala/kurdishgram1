...
public class StickerView extends EntityView
{
  ...
  protected Rect getSelectionBounds()
  {
    ...
    return new Rect((this.position.x - f2 / 2.0F) * f1, (this.position.y - f2 / 2.0F) * f1, f2 * f1, f1 * f2);
  }
  ...
  public class StickerViewSelectionView extends EntityView.SelectionView
  {
    ...
    public StickerViewSelectionView(Context arg2)
    {
      super(localContext);
    ...
    protected void onDraw(Canvas paramCanvas)
    {
      ...
      f2 = f2 + f1 + AndroidUtilities.dp(15.0F);
 ...
 * Qualified Name:     org.vidogram.ui.Components.Paint.Views.StickerView
