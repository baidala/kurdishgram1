...
public class Render
{
  ...
  private static void PaintSegment(Point paramPoint1, Point paramPoint2, RenderState paramRenderState)
  {
    ...
    while (true)
    {
      float f3 = Math.min(1.0F, paramRenderState.alpha * 1.15F);
      boolean bool2 = paramPoint1.edge;
      boolean bool3 = paramPoint2.edge;
      ...
      double d1 = paramRenderState.remainder;
      boolean bool1 = true;
      while (true)
      {
        float f2;
 ...
 * Qualified Name:     org.vidogram.ui.Components.Paint.Render
