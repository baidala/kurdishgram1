...
public class MenuDrawable extends Drawable
{
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    label355: for (int i = -180; ; i = 180)
    {
      ...
      float f4 = -AndroidUtilities.dp(9.0F);
      f4 = AndroidUtilities.dp(7.5F) * Math.abs(this.currentRotation) + f4;
  ...
  public void setRotation(float paramFloat, boolean paramBoolean)
  {
    ...
    if (this.currentRotation == 1.0F)
    {
      ...
      label49: this.lastFrameTime = System.currentTimeMillis();
    }
    for (this.finalRotation = paramFloat; ; this.finalRotation = paramFloat)
    {
      ...
      break;
      label83: this.currentAnimationTime = (int)((1.0F - this.currentRotation) * 300.0F);
      break label49;
      label100: this.currentRotation = paramFloat;
    }
  }
}

/* Location:           C:\Documents and Settings\soran\Desktop\s\classes.jar
 * Qualified Name:     org.vidogram.ui.ActionBar.MenuDrawable
