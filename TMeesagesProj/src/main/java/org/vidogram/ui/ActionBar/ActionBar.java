...
public class ActionBar extends FrameLayout
{
  ...
  public void hideActionMode()
  {
    ...
    do
    {
      ...
      this.actionModeAnimation.addListener(new AnimatorListenerAdapter()
      {
        ...
        {
          if ((ActionBar.this.actionModeAnimation != null) && (ActionBar.this.actionModeAnimation.equals(paramAnimator)))
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (this.occupyStatusBar)
    {
      ...
      if ((this.titleTextView != null) && (this.titleTextView.getVisibility() != 8))
      {
        ...
        if ((AndroidUtilities.isTablet()) || (getResources().getConfiguration().orientation != 2))
          break label535;
        f = 2.0F;
        label229: k = AndroidUtilities.dp(f) + k;
        label239: this.titleTextView.layout(j, i + k, this.titleTextView.getMeasuredWidth() + j, k + i + this.titleTextView.getTextHeight());
      }
      if ((this.subtitleTextView != null) && (this.subtitleTextView.getVisibility() != 8))
      {
    ...
    while (true)
    {
      ...
      label473: f = 72.0F;
      break label69;
      label481: if (AndroidUtilities.isTablet())
        f = 26.0F;
      while (true)
      {
        j = AndroidUtilities.dp(f);
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    if (this.occupyStatusBar)
    {
      ...
      if ((this.menu != null) && (this.menu.getVisibility() != 8))
      {
        ...
        if (!AndroidUtilities.isTablet())
          break label512;
        f = 74.0F;
        label143: i = View.MeasureSpec.makeMeasureSpec(j - AndroidUtilities.dp(f), 1073741824);
        label158: this.menu.measure(i, k);
      }
      if (((this.titleTextView != null) && (this.titleTextView.getVisibility() != 8)) || ((this.subtitleTextView != null) && (this.subtitleTextView.getVisibility() != 8)))
      {
        ...
        label223: i = j - i - AndroidUtilities.dp(16.0F) - paramInt2;
        if ((this.titleTextView != null) && (this.titleTextView.getVisibility() != 8))
        {
          ...
          if ((AndroidUtilities.isTablet()) || (getResources().getConfiguration().orientation != 2))
            break label538;
          paramInt2 = 18;
          label287: ((SimpleTextView)localObject).setTextSize(paramInt2);
        ...
        if ((this.subtitleTextView != null) && (this.subtitleTextView.getVisibility() != 8))
        {
          ...
          if ((AndroidUtilities.isTablet()) || (getResources().getConfiguration().orientation != 2))
            break label544;
          paramInt2 = 14;
          label368: ((SimpleTextView)localObject).setTextSize(paramInt2);
    ...
    while (true)
    {
      ...
      label480: f = 72.0F;
      break label102;
      label487: if (AndroidUtilities.isTablet())
        f = 26.0F;
      while (true)
      {
        paramInt2 = AndroidUtilities.dp(f);
      ...
      label512: f = 66.0F;
      break label143;
      label519: i = View.MeasureSpec.makeMeasureSpec(j, -2147483648);
      break label158;
      label532: i = 0;
      break label223;
  ...
  public void setOccupyStatusBar(boolean paramBoolean)
  {
    ...
    label37: for (int i = AndroidUtilities.statusBarHeight; ; i = 0)
    {
 ...
 * Qualified Name:     org.vidogram.ui.ActionBar.ActionBar
