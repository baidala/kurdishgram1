...
public class ActionBarMenu extends LinearLayout
{
  ...
  public ActionBarMenuItem addItem(int paramInt1, int paramInt2, int paramInt3, Drawable paramDrawable, int paramInt4)
  {
    ...
    while (true)
    {
      ...
      ((ActionBarMenuItem)localObject).setOnClickListener(new View.OnClickListener()
      {
        ...
        {
          ActionBarMenuItem localActionBarMenuItem = (ActionBarMenuItem)paramView;
          ...
          ActionBarMenu.this.onItemClick(((Integer)paramView.getTag()).intValue());
        }
      });
      return localObject;
      i = this.parentActionBar.itemsColor;
      break;
      label105: ((ActionBarMenuItem)localObject).iconView.setImageResource(paramInt2);
    }
  }
  ...
  protected void updateItemsBackgroundColor()
  {
    ...
    if (i < k)
    {
      ...
      if ((localView instanceof ActionBarMenuItem))
        if (!this.isActionMode)
          break label58;
      label58: for (int j = this.parentActionBar.itemsActionModeBackgroundColor; ; j = this.parentActionBar.itemsBackgroundColor)
      {
  ...
  protected void updateItemsColor()
  {
    ...
    if (i < k)
    {
      ...
      label62: for (int j = this.parentActionBar.itemsActionModeColor; ; j = this.parentActionBar.itemsColor)
      {
 ...
 * Qualified Name:     org.vidogram.ui.ActionBar.ActionBarMenu
