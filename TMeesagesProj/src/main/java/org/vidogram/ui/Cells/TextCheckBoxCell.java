  ...
  public TextCheckBoxCell(Context paramContext)
  {
    ...
    if (LocaleController.isRTL)
    {
      ...
      if (!LocaleController.isRTL)
        break label257;
      f2 = 17.0F;
      label134: addView(localTextView, LayoutHelper.createFrame(-1, -1.0F, i | 0x30, f1, 0.0F, f2, 0.0F));
    ...
    label257: label263: for (int i = j; ; i = 5)
    {
 ...
 * Qualified Name:     org.vidogram.ui.Cells.TextCheckBoxCell
