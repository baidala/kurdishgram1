...
public class TextCell extends FrameLayout
{
  ...
  public void changeValueTextColor()
  {
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (LocaleController.isRTL)
    {
      ...
      label90: this.textView.layout(paramInt1, paramInt4, this.textView.getMeasuredWidth() + paramInt1, this.textView.getMeasuredHeight() + paramInt4);
      paramInt4 = AndroidUtilities.dp(5.0F);
      if (LocaleController.isRTL)
        break label233;
      paramInt1 = AndroidUtilities.dp(16.0F);
      label138: this.imageView.layout(paramInt1, paramInt4, this.imageView.getMeasuredWidth() + paramInt1, this.imageView.getMeasuredHeight() + paramInt4);
      paramInt2 = (paramInt2 - this.valueImageView.getMeasuredHeight()) / 2;
      if (!LocaleController.isRTL)
        break label253;
    }
    label224: label233: label253: for (paramInt1 = AndroidUtilities.dp(24.0F); ; paramInt1 = paramInt3 - this.valueImageView.getMeasuredWidth() - AndroidUtilities.dp(24.0F))
    {
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    this.valueTextView.measure(View.MeasureSpec.makeMeasureSpec(paramInt1 - AndroidUtilities.dp(24.0F), -2147483648), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0F), 1073741824));
    this.textView.measure(View.MeasureSpec.makeMeasureSpec(paramInt1 - AndroidUtilities.dp(95.0F), -2147483648), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0F), 1073741824));
    this.imageView.measure(View.MeasureSpec.makeMeasureSpec(paramInt1, -2147483648), View.MeasureSpec.makeMeasureSpec(paramInt2, -2147483648));
    this.valueImageView.measure(View.MeasureSpec.makeMeasureSpec(paramInt1, -2147483648), View.MeasureSpec.makeMeasureSpec(paramInt2, -2147483648));
  ...
  public void setTextAndValueAndIconNofilter(String paramString1, String paramString2, int paramInt)
  {
    this.textView.setText(paramString1);
    this.valueTextView.setText(paramString2);
    this.valueTextView.setVisibility(0);
 ...
 * Qualified Name:     org.vidogram.ui.Cells.TextCell
