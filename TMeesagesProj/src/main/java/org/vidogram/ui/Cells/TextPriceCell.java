...
public class TextPriceCell extends FrameLayout
{
  ...
  public TextPriceCell(Context paramContext)
  {
    ...
    if (LocaleController.isRTL)
    {
      ...
      if (!LocaleController.isRTL)
        break label276;
      i = 5;
      label98: ((TextView)localObject).setGravity(i | 0x10);
      localObject = this.textView;
      if (!LocaleController.isRTL)
        break label281;
      i = 5;
      label121: addView((View)localObject, LayoutHelper.createFrame(-2, -1.0F, i | 0x30, 17.0F, 0.0F, 17.0F, 0.0F));
      ...
      if (!LocaleController.isRTL)
        break label286;
      i = 3;
      label225: paramContext.setGravity(i | 0x10);
      paramContext = this.valueTextView;
      if (!LocaleController.isRTL)
        break label291;
    }
    label276: label281: label286: label291: for (int i = j; ; i = 5)
    {
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    this.valueTextView.measure(View.MeasureSpec.makeMeasureSpec(paramInt2, -2147483648), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), 1073741824));
    paramInt2 = this.valueTextView.getMeasuredWidth();
    int i = AndroidUtilities.dp(8.0F);
    this.textView.measure(View.MeasureSpec.makeMeasureSpec(paramInt1 - paramInt2 - i, -2147483648), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), 1073741824));
  ...
  public void setTextAndValue(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    while (true)
    {
      ...
      break;
      label102: setTag("windowBackgroundWhiteGrayText2");
 ...
 * Qualified Name:     org.vidogram.ui.Cells.TextPriceCell
