...
public class PhotoPickerAlbumsCell extends FrameLayout
{
      ...
      this.albumViews[i].setOnClickListener(new View.OnClickListener()
      {
        public void onClick(View paramView)
        {
          if (PhotoPickerAlbumsCell.this.delegate != null)
            PhotoPickerAlbumsCell.this.delegate.didSelectAlbum(PhotoPickerAlbumsCell.this.albumEntries[((Integer)paramView.getTag()).intValue()]);
        }
      });
      i += 1;
    }
    ...
    if (paramAlbumEntry != null)
    {
      ...
      if ((paramAlbumEntry.coverPhoto != null) && (paramAlbumEntry.coverPhoto.path != null))
      {
        ...
        if (paramAlbumEntry.coverPhoto.isVideo)
          localAlbumView.imageView.setImage("vthumb://" + paramAlbumEntry.coverPhoto.imageId + ":" + paramAlbumEntry.coverPhoto.path, null, getContext().getResources().getDrawable(2130837964));
      }
      while (true)
      {
        ...
        return;
        localAlbumView.imageView.setImage("thumb://" + paramAlbumEntry.coverPhoto.imageId + ":" + paramAlbumEntry.coverPhoto.path, null, getContext().getResources().getDrawable(2130837964));
        continue;
        localAlbumView.imageView.setImageResource(2130837964);
      }
    }
  ...
  private class AlbumView extends FrameLayout
  {
    ...
    public AlbumView(Context arg2)
    {
      ...
      this.countTextView = new TextView(localContext);
 ...
 * Qualified Name:     org.vidogram.ui.Cells.PhotoPickerAlbumsCell
