...
public class PhotoAttachPhotoCell extends FrameLayout
{
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    while (true)
    {
      ...
      if (this.pressed)
      {
        ...
        if ((paramMotionEvent.getAction() == 2) && (!rect.contains((int)paramMotionEvent.getX(), (int)paramMotionEvent.getY())))
        {
          this.pressed = false;
          invalidate();
        }
  ...
  public void setPhotoEntry(MediaController.PhotoEntry paramPhotoEntry, boolean paramBoolean)
  {
    ...
    {
      this.imageView.setImage(this.photoEntry.thumbPath, null, getResources().getDrawable(2130837964));
    ...
    label206: for (paramBoolean = true; ; paramBoolean = false)
    {
      ...
      if (this.photoEntry.path != null)
      {
        ...
        this.imageView.setImage("thumb://" + this.photoEntry.imageId + ":" + this.photoEntry.path, null, getResources().getDrawable(2130837964));
        break;
      }
      this.imageView.setImageResource(2130837964);
      break;
    }
  }
 ...
 * Qualified Name:     org.vidogram.ui.Cells.PhotoAttachPhotoCell
