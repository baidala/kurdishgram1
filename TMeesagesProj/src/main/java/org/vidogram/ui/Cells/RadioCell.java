...
public class RadioCell extends FrameLayout
{
  ...
  public RadioCell(Context paramContext)
  {
    ...
    if (LocaleController.isRTL)
    {
      ...
      if (!LocaleController.isRTL)
        break label247;
      i = j;
      label190: if (!LocaleController.isRTL)
        break label252;
      j = 18;
      label200: f = j;
      if (!LocaleController.isRTL)
    ...
    label242: label247: label252: int k;
    label258: for (j = 0; ; k = 18)
    {
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    for (paramInt1 = 1; ; paramInt1 = 0)
    {
      ...
      this.radioButton.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(22.0F), -2147483648), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(22.0F), 1073741824));
 ...
 * Qualified Name:     org.vidogram.ui.Cells.RadioCell
