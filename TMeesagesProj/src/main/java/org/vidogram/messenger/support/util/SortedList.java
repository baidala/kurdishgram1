...
public class SortedList<T>
{
  ...
  private void addToData(int paramInt, T paramT)
  {
    ...
    {
      Object[] arrayOfObject = (Object[])(Object[])Array.newInstance(this.mTClass, this.mData.length + 10);
  ...
  {
    int i = this.mSize;
    this.mData = ((Object[])(Object[])Array.newInstance(this.mTClass, i + paramInt + 10));
    this.mMergedSize = 0;
    i = 0;
    while (true)
    {
      ...
      if ((j == 0) && (this.mCallback.areItemsTheSame(localObject1, localObject2)))
      {
 ...
 * Qualified Name:     org.vidogram.messenger.support.util.SortedList
