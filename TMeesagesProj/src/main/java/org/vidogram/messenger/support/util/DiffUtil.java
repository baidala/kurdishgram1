...
public class DiffUtil
{
    ...
    while (!localArrayList2.isEmpty())
    {
      ...
      if (localSnake != null)
      {
        ...
        if (localArrayList3.isEmpty())
        {
          ...
          label217: localRange1.oldListStart = localRange2.oldListStart;
          ...
          label265: localArrayList2.add(localRange1);
          if (!localSnake.reverse)
            break label457;
        ...
        while (true)
        {
          ...
          break label217;
          label362: if (localSnake.removal)
          {
          ...
          break label265;
          label420: localRange2.oldListStart = (localSnake.x + localSnake.size);
          localRange2.newListStart = (localSnake.y + localSnake.size + 1);
          continue;
          label457: localRange2.oldListStart = (localSnake.x + localSnake.size);
          localRange2.newListStart = (localSnake.y + localSnake.size);
        }
      }
  ...
  private static Snake diffPartial(Callback paramCallback, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int[] paramArrayOfInt1, int[] paramArrayOfInt2, int paramInt5)
  {
    ...
    label664: throw new IllegalStateException("DiffUtil hit an unexpected case while trying to calculate the optimal path. Please make sure your data is not changing during the diff calculation.");
  }
  ...
  public static class DiffResult
  {
    ...
    private boolean findMatchingItem(int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
    {
      ...
      while (true)
      {
        ...
        label269: paramInt2 = localSnake.x;
        i = localSnake.y;
        paramInt3 -= 1;
      }
      label289: return false;
    }
    ...
    public void dispatchUpdatesTo(ListUpdateCallback paramListUpdateCallback)
    {
      ...
      label234: paramListUpdateCallback.dispatchLastEvent();
    }
 ...
 * Qualified Name:     org.vidogram.messenger.support.util.DiffUtil
