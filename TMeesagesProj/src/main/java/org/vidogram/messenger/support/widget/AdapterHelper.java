  ...
  implements OpReorderer.Callback
{
  ...
  private f.a<UpdateOp> mUpdateOpPool = new f.b(30);
  ...
  private void dispatchAndUpdateViewHolders(UpdateOp paramUpdateOp)
  {
    ...
    label298: Object localObject = paramUpdateOp.payload;
    recycleUpdateOp(paramUpdateOp);
    if (n > 0)
    {
  ...
  private int updatePositionWithPostponed(int paramInt1, int paramInt2)
  {
    ...
    if (j >= 0)
    {
      ...
      while (true)
      {
        ...
        label201: if (paramInt1 < localUpdateOp.positionStart)
        {
          if (paramInt2 == 1)
          {
            localUpdateOp.positionStart += 1;
  ...
  {
    UpdateOp localUpdateOp = (UpdateOp)this.mUpdateOpPool.a();
  ...
  public void recycleUpdateOp(UpdateOp paramUpdateOp)
  {
    if (!this.mDisableRecycler)
    {
      ...
      this.mUpdateOpPool.a(paramUpdateOp);
    }
  }
      ...
      do
        while (true)
        {
          ...
          if (this.cmd != paramObject.cmd)
            return false;
          if ((this.cmd == 8) && (Math.abs(this.itemCount - this.positionStart) == 1) && (this.itemCount == paramObject.positionStart) && (this.positionStart == paramObject.itemCount))
            continue;
 ...
 * Qualified Name:     org.vidogram.messenger.support.widget.AdapterHelper
