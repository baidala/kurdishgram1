...
public final class FingerprintManagerCompat
{
  ...
  public void authenticate(CryptoObject paramCryptoObject, int paramInt, d paramd, AuthenticationCallback paramAuthenticationCallback, Handler paramHandler)
  {
    IMPL.authenticate(this.mContext, paramCryptoObject, paramInt, paramd, paramAuthenticationCallback, paramHandler);
  }
    ...
    implements FingerprintManagerCompat.FingerprintManagerCompatImpl
  {
    ...
    public void authenticate(Context paramContext, FingerprintManagerCompat.CryptoObject paramCryptoObject, int paramInt, d paramd, FingerprintManagerCompat.AuthenticationCallback paramAuthenticationCallback, Handler paramHandler)
    {
      FingerprintManagerCompatApi23.CryptoObject localCryptoObject = wrapCryptoObject(paramCryptoObject);
      if (paramd != null);
      for (paramCryptoObject = paramd.b(); ; paramCryptoObject = null)
      {
  ...
  {
    public abstract void authenticate(Context paramContext, FingerprintManagerCompat.CryptoObject paramCryptoObject, int paramInt, d paramd, FingerprintManagerCompat.AuthenticationCallback paramAuthenticationCallback, Handler paramHandler);
 ...
 * Qualified Name:     org.vidogram.messenger.support.fingerprint.FingerprintManagerCompat
