...
import android.support.v4.f.f.a;
import android.support.v4.f.f.b;

class ViewInfoStore
{
  private static final boolean DEBUG = false;
  final a<RecyclerView.ViewHolder, InfoRecord> mLayoutHolderMap = new a();
  final c<RecyclerView.ViewHolder> mOldChangedHolders = new c();
  ...
  private RecyclerView.ItemAnimator.ItemHolderInfo popFromLayoutStep(RecyclerView.ViewHolder paramViewHolder, int paramInt)
  {
    ...
    int i = this.mLayoutHolderMap.a(paramViewHolder);
    Object localObject1;
    if (i < 0)
    ...
    do
    {
      ...
      {
        return localObject1;
        localInfoRecord = (InfoRecord)this.mLayoutHolderMap.c(i);
        localObject1 = localObject2;
      }
  ...
  void process(ProcessCallback paramProcessCallback)
  {
    ...
    if (i >= 0)
    {
      RecyclerView.ViewHolder localViewHolder = (RecyclerView.ViewHolder)this.mLayoutHolderMap.b(i);
      InfoRecord localInfoRecord = (InfoRecord)this.mLayoutHolderMap.d(i);
  ...
  void removeFromDisappearedInLayout(RecyclerView.ViewHolder paramViewHolder)
  {
    ...
    if (paramViewHolder == null)
      return;
    paramViewHolder.flags &= -2;
  }

  void removeViewHolder(RecyclerView.ViewHolder paramViewHolder)
  {
    int i = this.mOldChangedHolders.b() - 1;
    while (true)
    {
      if (i >= 0)
      {
        if (paramViewHolder == this.mOldChangedHolders.c(i))
          this.mOldChangedHolders.a(i);
      }
      else
      {
  ...
  static class InfoRecord
  {
    ...
    static f.a<InfoRecord> sPool = new f.b(20);
    int flags;
 ...
 * Qualified Name:     org.vidogram.messenger.support.widget.ViewInfoStore
