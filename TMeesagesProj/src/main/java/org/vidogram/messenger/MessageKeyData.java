...
public class MessageKeyData
{
  ...
  public static MessageKeyData generateMessageKeyData(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, boolean paramBoolean)
  {
    ...
    for (int i = 8; ; i = 0)
    {
      ...
      paramArrayOfByte2.writeBytes(localObject1, 8, 12);
      paramArrayOfByte2.writeBytes(localObject2, 4, 12);
      ...
      paramArrayOfByte2.writeBytes(localObject1, 0, 8);
      paramArrayOfByte2.writeBytes(localObject2, 16, 4);
 ...
 * Qualified Name:     org.vidogram.messenger.MessageKeyData
