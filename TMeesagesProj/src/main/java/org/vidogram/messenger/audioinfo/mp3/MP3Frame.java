...
public class MP3Frame
{
  ...
  public int getNumberOfFrames()
  {
    ...
    if (isXingFrame())
    {
      ...
      if ((this.bytes[(i + 7)] & 0x1) != 0)
      {
        ...
        k = this.bytes[(i + 9)];
        m = this.bytes[(i + 10)];
        return this.bytes[(i + 11)] & 0xFF | ((j & 0xFF) << 24 | (k & 0xFF) << 16 | (m & 0xFF) << 8);
      }
    }
    else if (isVBRIFrame())
    {
      ...
      k = this.bytes[(i + 15)];
      m = this.bytes[(i + 16)];
      return this.bytes[(i + 17)] & 0xFF | ((j & 0xFF) << 24 | (k & 0xFF) << 16 | (m & 0xFF) << 8);
    }
    return -1;
  }
  ...
  static final class CRC16
  {
    ...
    public void update(int paramInt1, int paramInt2)
    {
      ...
      label73: label79: for (this.crc = (short)(this.crc ^ 0x8005); ; this.crc = (short)(this.crc << 1))
      {
        i = paramInt2 >>> 1;
        paramInt2 = i;
        if (i != 0)
  ...
  public static class Header
  {
    ...
    static
    {
      ...
      int[] arrayOfInt5 = { 320000, 192000, 160000, 160000, 96000 };
      int[] arrayOfInt6 = { 352000, 224000, 192000, 176000, 112000 };
      int[] arrayOfInt7 = { 384000, 256000, 224000, 192000, 128000 };
      int[] arrayOfInt8 = { 448000, 384000, 320000, 256000, 160000 };
      int[] arrayOfInt9 = { -1, -1, -1, -1, -1 };
      BITRATES = new int[][] { arrayOfInt1, arrayOfInt2, { 64000, 48000, 40000, 48000, 16000 }, { 96000, 56000, 48000, 56000, 24000 }, arrayOfInt3, arrayOfInt4, { 192000, 96000, 80000, 96000, 48000 }, { 224000, 112000, 96000, 112000, 56000 }, { 256000, 128000, 112000, 128000, 64000 }, { 288000, 160000, 128000, 144000, 80000 }, arrayOfInt5, arrayOfInt6, arrayOfInt7, { 416000, 320000, 256000, 224000, 144000 }, arrayOfInt8, arrayOfInt9 };
      BITRATES_COLUMN = new int[][] { { -1, 4, 4, 3 }, { -1, -1, -1, -1 }, { -1, 4, 4, 3 }, { -1, 2, 1, 0 } };
      arrayOfInt1 = new int[] { -1, -1, -1, -1 };
      arrayOfInt2 = new int[] { -1, 144, 144, 12 };
      SIZE_COEFFICIENTS = new int[][] { { -1, 72, 144, 12 }, arrayOfInt1, { -1, 72, 144, 12 }, arrayOfInt2 };
 ...
 * Qualified Name:     org.vidogram.messenger.audioinfo.mp3.MP3Frame
