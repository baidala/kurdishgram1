  ...
  public static SpsData parseSpsNalUnit(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    if ((paramInt1 == 100) || (paramInt1 == 110) || (paramInt1 == 122) || (paramInt1 == 244) || (paramInt1 == 44) || (paramInt1 == 83) || (paramInt1 == 86) || (paramInt1 == 118) || (paramInt1 == 128) || (paramInt1 == 138))
    {
      ...
      if (paramArrayOfByte.readBit())
      {
        if (j != 3)
        {
          paramInt1 = 8;
          paramInt2 = 0;
          label153: if (paramInt2 >= paramInt1)
            break label201;
          if (paramArrayOfByte.readBit())
            if (paramInt2 >= 6)
              break label194;
        }
        label194: for (i = 16; ; i = 64)
        {
    ...
    label201: for (int i = j; ; i = 1)
    {
      ...
      for (i = k - i * (i3 + i4); ; i = k)
      {
        ...
        while (true)
        {
          return new SpsData(n, paramInt1, i, f1, bool1, bool3, i1 + 4, i2, paramInt2, bool2);
          paramInt2 = j;
          if (i2 != 1)
            break;
          bool3 = paramArrayOfByte.readBit();
 ...
 * Qualified Name:     org.vidogram.messenger.exoplayer2.util.NalUnitUtil
