  ...
  public boolean read(ExtractorInput paramExtractorInput)
  {
    ...
    while (true)
    {
      ...
      case 1:
        ...
        this.masterElementsStack.add(new MasterElement(this.elementId, l2 + l1, null));
 ...
 * Qualified Name:     org.vidogram.messenger.exoplayer2.extractor.mkv.DefaultEbmlReader
