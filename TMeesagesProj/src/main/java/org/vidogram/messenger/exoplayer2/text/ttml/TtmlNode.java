...
import java.util.List<Lorg.vidogram.messenger.exoplayer2.text.Cue;>;
...
final class TtmlNode
{
  ...
  private void getEventTimes(TreeSet<Long> paramTreeSet, boolean paramBoolean)
  {
    ...
    if (this.children == null)
      return;
    int i = 0;
    label76: TtmlNode localTtmlNode;
    ...
    label131: for (boolean bool1 = true; ; bool1 = false)
    {
  ...
  public List<Cue> getCues(long paramLong, Map<String, TtmlStyle> paramMap, Map<String, TtmlRegion> paramMap1)
  {
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      paramMap.add(new Cue(cleanUpText((SpannableStringBuilder)localEntry.getValue()), null, localTtmlRegion.line, localTtmlRegion.lineType, -2147483648, localTtmlRegion.position, -2147483648, localTtmlRegion.width));
    }
    return (List<Cue>)paramMap;
  }
 ...
 * Qualified Name:     org.vidogram.messenger.exoplayer2.text.ttml.TtmlNode
