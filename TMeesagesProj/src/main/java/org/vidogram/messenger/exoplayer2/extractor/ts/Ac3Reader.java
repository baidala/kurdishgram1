  ...
  private void parseHeader()
  {
    ...
    if (this.format == null)
    {
      ...
      if (this.headerScratchBits.readBits(5) == 16)
      {
        ...
        label74: this.format = localFormat;
    ...
    else
    {
      ...
      label110: this.sampleSize = i;
      if (!this.isEac3)
        break label191;
    }
    label160: label177: label191: for (int i = Ac3Util.parseEAc3SyncframeAudioSampleCount(this.headerScratchBits.data); ; i = Ac3Util.getAc3SyncframeAudioSampleCount())
    {
      this.sampleDurationUs = (int)(i * 1000000L / this.format.sampleRate);
      return;
      bool = false;
      break;
 ...
 * Qualified Name:     org.vidogram.messenger.exoplayer2.extractor.ts.Ac3Reader
