...
public final class MpegAudioHeader
{
  ...
  public static boolean populateHeader(int paramInt, MpegAudioHeader paramMpegAudioHeader)
  {
    ...
    label206: for (k = BITRATE_V1_L1[(k - 1)]; ; k = BITRATE_V2_L1[(k - 1)])
    {
      m = (k * 12000 / i + i1) * 4;
      j = 384;
 ...
 * Qualified Name:     org.vidogram.messenger.exoplayer2.extractor.MpegAudioHeader
