  ...
  public static int getTrackType(String paramString)
  {
    ...
    do
    {
      ...
      if (isVideo(paramString))
        return 2;
      if ((isText(paramString)) || ("application/cea-608".equals(paramString)) || ("application/cea-708".equals(paramString)) || ("application/x-subrip".equals(paramString)) || ("application/ttml+xml".equals(paramString)) || ("application/x-quicktime-tx3g".equals(paramString)) || ("application/x-mp4vtt".equals(paramString)) || ("application/x-rawcc".equals(paramString)) || ("application/vobsub".equals(paramString)) || ("application/pgs".equals(paramString)))
        return 3;
    }
    while (!"application/id3".equals(paramString));
    return 4;
  }
 ...
 * Qualified Name:     org.vidogram.messenger.exoplayer2.util.MimeTypes
