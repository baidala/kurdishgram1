...
final class FixedSampleSizeRechunker
{
  ...
  public static Results rechunk(int paramInt, long[] paramArrayOfLong, int[] paramArrayOfInt, long paramLong)
  {
    ...
    return new Results(arrayOfLong1, arrayOfInt1, j, arrayOfLong2, arrayOfInt2, null);
  }
 ...
 * Qualified Name:     org.vidogram.messenger.exoplayer2.extractor.mp4.FixedSampleSizeRechunker
