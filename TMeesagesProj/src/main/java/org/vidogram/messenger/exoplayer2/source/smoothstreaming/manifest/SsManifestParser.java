package org.vidogram.messenger.exoplayer2.source.smoothstreaming.manifest;
  ...
  implements ParsingLoadable.Parser<SsManifest>
{
  ...
  private static abstract class ElementParser
  {
    ...
    protected final int parseInt(XmlPullParser paramXmlPullParser, String paramString, int paramInt)
    {
      ...
      catch (java.lang.NumberFormatException paramXmlPullParser)
      {
      }
  ...
  private static class QualityLevelParser extends SsManifestParser.ElementParser
  {
    ...
    public void parseStartTag(XmlPullParser paramXmlPullParser)
    {
      ...
      if (j == 2)
      {
        this.format = Format.createVideoContainerFormat(str, "video/mp4", (String)localObject2, null, i, parseRequiredInt(paramXmlPullParser, "MaxWidth"), parseRequiredInt(paramXmlPullParser, "MaxHeight"), -1.0F, buildCodecSpecificData(paramXmlPullParser.getAttributeValue(null, "CodecPrivateData")));
        return;
      }
      if (j == 1)
      {
      ...
      this.format = Format.createContainerFormat(str, "application/mp4", null, (String)localObject2, i);
    }
  }
  ...
  private static class StreamIndexParser extends SsManifestParser.ElementParser
  {
    ...
    private void parseStreamFragmentStartTag(XmlPullParser paramXmlPullParser)
    {
      ...
      while (true)
      {
        ...
        label109: if (this.lastChunkDuration != -1L)
        {
          l1 = ((Long)this.startTimes.get(i - 1)).longValue() + this.lastChunkDuration;
          continue;
        }
 ...
 * Qualified Name:     org.vidogram.messenger.exoplayer2.source.smoothstreaming.manifest.SsManifestParser
