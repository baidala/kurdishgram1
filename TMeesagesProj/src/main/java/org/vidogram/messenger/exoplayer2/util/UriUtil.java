...
public final class UriUtil
{
  ...
  private static int[] getUriIndices(String paramString)
  {
    ...
    while (true)
    {
      ...
      label173: label202: for (k = i; ; k = m + 1)
      {
        arrayOfInt[0] = m;
        arrayOfInt[1] = k;
        arrayOfInt[2] = i;
  ...
  private static String removeDotSegments(StringBuilder paramStringBuilder, int paramInt1, int paramInt2)
  {
    ...
    if (paramInt2 <= j)
    {
      ...
      {
        k = paramInt2;
        label52: if ((paramInt2 != paramInt1 + 1) || (paramStringBuilder.charAt(paramInt1) != '.'))
          break label122;
      ...
      while (true)
      {
        ...
        paramInt2 += 1;
        break;
        label122: if ((paramInt2 == paramInt1 + 2) && (paramStringBuilder.charAt(paramInt1) == '.') && (paramStringBuilder.charAt(paramInt1 + 1) == '.'))
        {
 ...
 * Qualified Name:     org.vidogram.messenger.exoplayer2.util.UriUtil
