...
final class VorbisUtil
{
  ...
  private static CodeBook readBook(VorbisBitArray paramVorbisBitArray)
  {
    ...
    int n = paramVorbisBitArray.readBits(16);
    int i1 = paramVorbisBitArray.readBits(24);
    ...
    else
    {
      ...
      {
        int i2 = paramVorbisBitArray.readBits(iLog(i1 - j));
        int m = 0;
    ...
    if ((i == 1) || (i == 2))
    {
      ...
      if (n == 0)
        break label333;
      l = mapType1QuantValues(i1, n);
    }
    while (true)
    {
      paramVorbisBitArray.skipBits((int)(l * (k + 1)));
      return new CodeBook(n, i1, arrayOfLong, i, bool1);
      label333: l = 0L;
      continue;
      label339: l = i1 * n;
    }
  ...
  private static void readResidues(VorbisBitArray paramVorbisBitArray)
  {
    ...
    label179: for (int k = paramVorbisBitArray.readBits(5); ; k = 0)
    {
      arrayOfInt[j] = (k * 8 + i1);
      j += 1;
      break label80;
 ...
 * Qualified Name:     org.vidogram.messenger.exoplayer2.extractor.ogg.VorbisUtil
