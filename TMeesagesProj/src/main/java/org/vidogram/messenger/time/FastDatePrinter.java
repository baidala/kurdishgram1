  ...
  implements Serializable, DatePrinter
{
  ...
  protected List<Rule> parsePattern()
  {
    ...
    while (true)
    {
      ...
      {
        localObject = new TextField(7, localObject);
        break;
      }
  ...
  private static abstract interface NumberRule extends FastDatePrinter.Rule
  {
  ...
  private static class TimeZoneDisplayKey
  {
    ...
    public boolean equals(Object paramObject)
    {
      ...
      while (true)
      {
        ...
        if ((!this.mTimeZone.equals(paramObject.mTimeZone)) || (this.mStyle != paramObject.mStyle) || (!this.mLocale.equals(paramObject.mLocale)))
          return false;
      }
      return false;
    }
 ...
 * Qualified Name:     org.vidogram.messenger.time.FastDatePrinter
