  ...
  implements Serializable, DateParser
{
  ...
  static
  {
    ...
    ABBREVIATED_YEAR_STRATEGY = new NumberStrategy(1)
    {
      void setCalendar(FastDateParser paramFastDateParser, Calendar paramCalendar, String paramString)
      {
        ...
        int i = j;
        if (j < 100)
          i = paramFastDateParser.adjustYear(j);
  ...
  private static class CopyQuotedStrategy extends FastDateParser.Strategy
  {
    ...
    {
      FastDateParser.access$100(paramStringBuilder, this.formatField, true);
      return false;
    }
  ...
  private static class TextStrategy extends FastDateParser.Strategy
  {
    ...
    TextStrategy(int paramInt, Calendar paramCalendar, Locale paramLocale)
    {
      super();
      this.field = paramInt;
      this.keyValues = FastDateParser.access$200(paramInt, paramCalendar, paramLocale);
    }
 ...
 * Qualified Name:     org.vidogram.messenger.time.FastDateParser
